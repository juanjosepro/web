      ...
      <div class="relative w-4/5 mx-auto mb-5 md:flex md:items-end md:w-auto lg:justify-end lg:items-start lg:w-full hidden">
        <div class="project__main relative lg:w-96 lg:pt-6">
          ...
          <div class="flex items-center mt-10">
            <a href={projectSelected.urlWeb} target="_blank" class="animate-focus-in-blur-out see_demo flex gap-1 items-center underline decoration-gray-400 mr-12 dark:text-gray-200 underline-offset-2">
            ...
            <a href={projectSelected.urlGit} target="_blank" class="animate-focus-in-blur-out see_repo flex gap-1 items-center underline decoration-gray-400 dark:text-gray-200 underline-offset-2">
